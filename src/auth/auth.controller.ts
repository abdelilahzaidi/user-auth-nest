import { BadRequestException, Body, Controller, Get, InternalServerErrorException, NotFoundException, Post, Req, Res } from '@nestjs/common';
...
async user(@Req() request: Request) {
        ...
        const user = await this.authService.findOneBy({where:{ id: data['id'] }});
